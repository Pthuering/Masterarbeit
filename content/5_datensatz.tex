...
% Ziel: 8-10 Seiten
    ...
    % KERNKAPITEL - hier entsteht die Basis für das Fine-Tuning
        ...
        %
        % 3b. RICHTUNGSSPEZIFISCHE ANGABEN-VALIDIERUNG
        % - Prüfung korrekter Formatierung richtungsspezifischer Informationen
        % - Pattern-Matching für Richtungsangaben: "Richtung [ZIELORT]:"
        %   * Regex-basierte Erkennung: "Richtung\s+\w+:"
        %   * Validierung der Reihenfolge: Schlüsselwort → Richtungsangabe → Doppelpunkt
        %   * Beispiele: "Richtung Hauptbahnhof:", "Richtung Connewitz:", "Richtung Gohlis:"
        % - Identifikation fehlerhafter Formate:
        %   * Fehlendes Doppelpunkt: "Richtung Hauptbahnhof"
        %   * Falsche Reihenfolge: ": Richtung Hauptbahnhof"
        %   * Fehlende Richtungsangabe: "Richtung:"
        % - Konsistenzprüfung bei mehreren Richtungsangaben im selben Text
        % - Validierung, dass bei richtungsspezifischen Maßnahmen die Formatierung eingehalten wird
        %
