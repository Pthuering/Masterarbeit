...
% \include{config/background}
    ...
    % Formatierungsbeispiele und Hinweise (aus alter Dummy-Gliederung)
    \include{content/hinweise}
    \include{content/hinweise_problem}
    \include{content/hinweise_analyse}
    \include{content/hinweise_synthese}
